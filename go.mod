...
require (
	...
	gonum.org/v1/gonum v0.9.1-0.20210325102323-76f2be9ab53e
...
replace (
	...
	github.com/moby/sys/mountinfo => github.com/moby/sys/mountinfo v0.2.0

	// Current version of runc (v1.0.2) is broken
